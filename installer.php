...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200701_wordpresstemplate_deb20109f959781a6205_20200701175721_archive.zip';
	const ARCHIVE_SIZE		 = '105110510';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'deb2010-01175721';
    const SECONDARY_PACKAGE_HASH = '37aac9a-01175721';
